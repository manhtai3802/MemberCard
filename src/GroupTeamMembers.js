...
const GroupTeamMembers = ({ employees, selectTeam, setTeam }) => {
  const [groupEmployee, setGroupedData] = useState(groupTeamMembers());
  ...
  function handleTeamClick(event) {
    var transformedGroupData = groupEmployee.map((groupedData) =>
